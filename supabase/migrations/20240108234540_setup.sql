...
AS $$
DECLARE
  project_url TEXT := 'https://wpfawsvafncjnxqndowc.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6IndwZmF3c3ZhZm5jam54cW5kb3djIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNTIzMDkwMiwiZXhwIjoyMDIwODA2OTAyfQ.KN8tcS0EfkwneW24EQ3Er3W-y_g-W-iKZeexhpsD8fI'; -- full access needed for http request to storage
